%% STEAM
% Correlation for observed concentrations and true concentrations at 6ms
% for cystathionine

% Example data (replace with your actual data)
obs = [3.355, 2.519, 0.468, 10.951, 11.904]; % observed concentrations 
...
title('Correlation between Observed and True Concentrations of Cystathionine at 6ms (STEAM)');
grid on;
