%Script for figure 8 (overlaid spectra at TE=78ms, PRESS)
%Read data for 2mM of 2HG
data= readmatrix('NeuroOnc_MRC_Project/SS/Data_Analysis/Overlay Data/PRESS/2mM_PRESS_78_smag.csv'); %2mM 2HG
chemical_shifts = data(:, 1);
amplitude_values = data(:, 2);

% Read data for 8mM of 2HG
data2 = readmatrix('NeuroOnc_MRC_Project/SS/Data_Analysis/Overlay Data/PRESS/8mM_PRESS_78_smag.csv'); %8mM 2HG
...
ylabel('Amplitude');
title('NMR Spectra for Phantoms at 78ms');
